    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <!-- en sökruta för produkterna -->
          <form action="get">
            <div class="">
              <input name="q" class="" type="search" placeholder="search for something">
              <button class="btn-btn-outlined" id="search-button" type="submit">sök </button>
            </div>
